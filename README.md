...
El diagrama será incorporado una vez finalizado el modelado de la base de datos.

<!-- Ejemplo para agregarlo posteriormente: ![Diagrama del Proyecto](./docs/diagrama.png) -->
...
3. Abrir database/script.sql.
4. Ejecutar el script completo.
5. Se creará la base de datos InmobiliariaNN.
6. El script creará e inicializará las tablas Propietario e Inquilino.